...
# First, confirm your TCP Server is running on local machine (port: 65432):
...
# Step one, open an interactive session:
# nc localhost 65432

# # Step two, connect to the server and send multiple messages
# {
#   echo -n -e "\x00\x0F357544374597827"
